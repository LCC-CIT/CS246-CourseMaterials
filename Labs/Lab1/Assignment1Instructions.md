<h1>Instructions for Assignment 1</h1>
...
Develop a *requirements document* that describes the requirements for a software system that will solve business problems for a hypothetical business as described in the transcript of an interview with the business owner.
...
Identify additional information that you are going to need for your requirements document and write a hypothetical second interview in which you ask the business owner additional questions to get more details on the requirements for the software system you are going to design for them. (You will make up answers for them).

You may decide that in the first interview the interviewee identified more needs/problems than you could solve with one system. In that case, you will narrow down the questions you ask in the second interview to focus on just the problems you plan to solve with the system you write the requirements for.

Focus your questions on getting more details about the requirements. Don't propose features, get them to tell you what features they want. Don't talk about schedule, budget, UX design, or any of the implementation details, all you want are requirements for the functionality the system will need to have.
...
Plan your work in a way to ensure that each person on your team contributes equally to the assignment. When you divide up the work, recognize that the functional requirements section of the document will be the "heart" of that document and everyone should contribute to that.
...
Written by Brian Bird, Lane Community College, 2025, revised <time>2026</time>.

------

*Note: Drafts for the simulated interviews for this assignment were generated by ChatGPT using the GPT 4o model and by Gemini 1.5 Flash, 2025.*
